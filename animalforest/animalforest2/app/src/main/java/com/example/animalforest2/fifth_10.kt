...
class fifth_10 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fifth_10)
        ...
        fun saveRes(Key: String, Value: Int) {
            val pref = getSharedPreferences("result10", Context.MODE_PRIVATE)
            val ed = pref.edit()
            ed.putInt(Key, Value)
            ed.apply()
        }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        var result: Int = 25
        val pref = getSharedPreferences("result10", Context.MODE_PRIVATE)
        result = pref.getInt("result10", 25)
