...
class fifth_8 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fifth_8)
        ...
        fun saveRes(Key: String, Value: Int) {
            val pref = getSharedPreferences("result8", Context.MODE_PRIVATE)
            val ed = pref.edit()
            ed.putInt(Key, Value)
            ed.apply()
        }
