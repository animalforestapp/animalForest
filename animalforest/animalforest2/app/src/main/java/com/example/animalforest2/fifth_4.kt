...
class fifth_4 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fifth_4)
        ...
        fun saveRes(Key: String, Value: Int) {
            val pref = getSharedPreferences("result4", Context.MODE_PRIVATE)
            val ed = pref.edit()
            ed.putInt(Key, Value)
            ed.apply()
        }
